...
import com.example.happevents.Model.Products;
import com.example.happevents.Prevalent.Prevalent;
import com.example.happevents.ViewHolder.ProductViewHolder;
...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_search, R.id.nav_categories, R.id.nav_settings,
